        ...
        <div class="container-fluid">
            <form action="MainController">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="password" placeholder="Enter Password" name="password" value="${param.password}" required=""/>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="password" placeholder="Confirm Password" name="confirmPassword" value="${param.password}" required="" />
                    </div>
                </div>
                <div class="row mb-3">
