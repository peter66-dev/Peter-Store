        ...
        try {
            ...
            if (search.trim().length() == 0) {
                ...
                if ("Product Name".equalsIgnoreCase(userChoice)) {
                    ...
                    list = product.getListByProductName(search);
                } else if ("Category ID".equalsIgnoreCase(userChoice)) {
                    ProductDAO product = new ProductDAO();
                    list = product.getListByCategoryName(search);
                } else if ("Writer".equalsIgnoreCase(userChoice)) {
                    ProductDAO product = new ProductDAO();
                    list = product.getListByWriter(search);
                }
